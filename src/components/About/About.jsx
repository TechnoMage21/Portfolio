...
export default function About() {
  ...
  return (
    ...
    <div ref={ref} className={`about-section ${inView ? 'animate' : ''}`}>
      <h1>About Me</h1>
      <p>Hi, I'm Om Gupta, a passionate developer with skills in frontend and backend development.</p>
      <p>I have recently completed my MCA and have experience working with various technologies, including React(basic), PHP and more.</p>
